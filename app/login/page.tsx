    ...
    <div className="flex-1 flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-slate-50">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-[480px]">
        <div className="bg-white py-8 px-4 shadow-card sm:rounded-[24px] sm:px-10 border border-slate-200">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-slate-300 rounded text-blue-600 cursor-pointer"
                />
          ...
          <div className="mt-8">
            ...
            <div className="mt-6">
              <button
                type="button"
                className="w-full flex justify-center items-center gap-3 py-3 px-4 border border-slate-200 rounded-xl shadow-sm bg-white text-sm font-medium text-slate-700 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 transition-colors"
              >
        ...
        <div className="mt-8 bg-blue-50 border border-blue-100 rounded-xl p-4 flex items-start space-x-3">
          ...
          <div>
            <h4 className="text-sm font-semibold text-blue-800">Why create an account?</h4>
            <p className="mt-1 text-sm text-blue-700">
              Creating an account is entirely optional. It simply allows you to save history, favorite your most used tools, and sync preferences across devices.
            </p>
          </div>
        </div>
      </div>
